...
public enum Clock {
  ...
  // función pasado un tiempo
  // El nombre es largo y parece confusa, pero es importante para la lógica del
  // clock
  private ScheduledFuture<?> currentTickTask;
  // Este atributo es para almacenar el "proceso" del scheduler
  // Es importante porque, si después queremos cambiar la velocidad de cada cuanto
  // hay un tick
